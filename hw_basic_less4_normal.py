...
if not re.search(pattern, surname):
    print('фамилия введено неверно')
if not re.search(r'^[a-z_0-9]+@[a-z_0-9]+\.ru|com|org$', email):
    print('email введено неверно')
...
if re.search(r'\.{2,}', some_str):
    print('найдено несколько точек')
else:
    print('несколько точек не найдено')

result = re.search(r'(\.{2,})', some_str).group(1)
print(result)
